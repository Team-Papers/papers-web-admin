...
export function StatCard({
  ...
  return (
    <div
      className="rounded-2xl border border-outline-variant bg-surface p-6 transition-all duration-200 hover:shadow-md hover:border-primary-200 animate-fade-up"
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div className={cn(
          'flex h-12 w-12 items-center justify-center rounded-2xl transition-transform hover:scale-110',
          iconBg
        )}>
          {icon}
        </div>
