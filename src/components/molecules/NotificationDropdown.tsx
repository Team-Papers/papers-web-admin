...
function getNotificationIcon(type: NotificationType) {
  switch (type) {
    ...
    case 'NEW_SALE':
    case 'BOOK_PURCHASED':
      return <DollarSign className="w-5 h-5 text-info" />;
    case 'NEW_REVIEW':
    ...
    default:
      return <Bell className="w-5 h-5 text-on-surface-muted" />;
  }
}
    ...
    >
      ...
      <div className="flex-shrink-0 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <button
          ...
          className="p-1 hover:bg-error-container rounded"
          title="Supprimer"
        >
...
export function NotificationDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-96 max-h-[70vh] bg-surface rounded-xl shadow-lg border border-outline-variant overflow-hidden z-50">
          {/* Header */}
