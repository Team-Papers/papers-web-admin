# Déploiement — Papers Admin Dashboard
...
| **URL de production** | https://admin.papers237.duckdns.org |
...
| **Répertoire sur le VPS** | `/home/softengine/papers-web-admin` |
...
Fichier : `/etc/nginx/sites-enabled/papers-web-admin`

```nginx
server {
    server_name admin.papers237.duckdns.org;

    root /home/softengine/papers-web-admin/dist;
    index index.html;
...
source ~/.nvm/nvm.sh
cd /home/softengine/papers-web-admin
...
```bash
# Accès direct
curl -sf https://admin.papers237.duckdns.org | head -5

# Vérifier que le build existe
ls -la /home/softengine/papers-web-admin/dist/
```
